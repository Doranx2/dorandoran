...
import com.ezen.doran.service.user.*;
		  ...
		  try {
			  ...
			  if(findUser == null) {
				  ...
				  if(!findUser.getUserEmail().equals(userDTO.getUserEmail())){
					  ...
					  /*UserDTO idUser = UserDTO.builder()
				                              .userId(findUser.getUserId())
				                              .userAge(findUser.getUserAge())
				                              .userEmail(findUser.getUserEmail())
				                              .userGen(findUser.getUserGen())
				                              .userLoc(findUser.getUserLoc())
		  ...
		  if(fndPwUser == null) {
			  ...
			  if(!fndPwUser.getUserEmail().equals(userDTO.getUserEmail())) {
				  ...
				  /*UserDTO pwUser = userDTO.builder()
                          ...
                          .userGen(fndPwUser.getUserGen())
                          .userLoc(fndPwUser.getUserLoc())
                          .userPw(fndPwUser.getUserPw())
                          .userNick(fndPwUser.getUserNick())
