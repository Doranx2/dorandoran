package com.ezen.doran.configuration;
...
import com.ezen.doran.handler.LoginFailureHandler;
import com.ezen.doran.handler.LoginSuccessHandler;
import com.ezen.doran.oauth.Oauth2UserService;
...
public class SecurityConfiguration {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/").permitAll()
									...
									.antMatchers("/cscenter/**").permitAll()
